.. doc-oc-lettings-apps documentation master file, created by
   sphinx-quickstart on Wed Aug 30 01:08:43 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

*****************************************
Documentation du Projet - OC Lettings v.1
*****************************************
...
.. toctree::
   ...
   structure-base-donnees-modeles
   interfaces-programmation
   guide-utilisation
   procedures-de-deploiement-gestion
